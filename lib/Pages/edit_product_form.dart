...
class _EditProductFormState extends State<EditProductForm> {
  ...
  late TextEditingController _minQuantityForDiscountController;
  ...
  void initState() {
    ...
    _minQuantityForDiscountController = TextEditingController(
      text: widget.product.minQuantityForDiscount?.toString() ?? '',
    );
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Set a percentage discount for orders above a certain quantity. Leave blank for no discount.',
                  style: GoogleFonts.poppins(
                    fontSize: 12,
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: TextFormField(
                        controller: _minQuantityForDiscountController,
                        keyboardType: TextInputType.number,
                        style: GoogleFonts.poppins(
                          color:
                              widget.isDarkMode ? Colors.white : Colors.black87,
                              ...
                              try {
                                ...
                                final updatedProduct = widget.product.copyWith(
                                  ...
                                  minQuantityForDiscount:
                                      _minQuantityForDiscountController
                                              .text.isNotEmpty
                                          ? double.tryParse(
                                              _minQuantityForDiscountController
                                                  .text)
                                ...
                                // Always include discount fields in Firestore update
                                final productMap = updatedProduct.toMap();
                                productMap['discountPercentage'] =
                                    updatedProduct.discountPercentage;
                                productMap['minQuantityForDiscount'] =
                                    updatedProduct.minQuantityForDiscount;
